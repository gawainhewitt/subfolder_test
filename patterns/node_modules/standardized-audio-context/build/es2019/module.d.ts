...
export declare const isAnyAudioContext: import("standardized-audio-context/src/types").TIsAnyAudioContextFunction;
export declare const isAnyAudioNode: import("standardized-audio-context/src/types").TIsAnyAudioNodeFunction;
export declare const isAnyAudioParam: import("standardized-audio-context/src/types").TIsAnyAudioParamFunction;
export declare const isAnyOfflineAudioContext: import("standardized-audio-context/src/types").TIsAnyOfflineAudioContextFunction;
