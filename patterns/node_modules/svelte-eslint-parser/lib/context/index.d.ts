import type { Comment, Locations, SvelteElement, SvelteHTMLElement, SvelteScriptElement, SvelteSnippetBlock, SvelteStyleElement, Token } from "svelte-eslint-parser/lib/ast";
import type ESTree from "estree";
import type * as SvAST from "svelte-eslint-parser/lib/parser/svelte-ast-types";
import type * as Compiler from "svelte-eslint-parser/lib/parser/svelte-ast-types-for-v5";
import { ScriptLetContext } from "svelte-eslint-parser/lib/context/script-let";
import { LetDirectiveCollections } from "svelte-eslint-parser/lib/context/let-directive-collection";
import { type NormalizedParserOptions } from "svelte-eslint-parser/lib/parser/parser-options";
