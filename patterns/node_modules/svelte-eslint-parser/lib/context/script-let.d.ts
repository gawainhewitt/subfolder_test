...
import type { Context } from "svelte-eslint-parser/lib/context";
import type { Comment, SvelteEachBlock, SvelteIfBlock, SvelteName, SvelteNode, SvelteSnippetBlock, Token } from "svelte-eslint-parser/lib/ast";
import type { ESLintExtendedProgram } from "svelte-eslint-parser/lib/parser";
