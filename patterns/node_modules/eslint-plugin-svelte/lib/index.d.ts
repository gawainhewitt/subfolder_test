import 'eslint-plugin-svelte/lib/rule-types';
import type { RuleModule } from 'eslint-plugin-svelte/lib/types';
import * as processor from 'eslint-plugin-svelte/lib/processor';
